...
var _asyncConsole = _interopRequireDefault(require("../utils/async-console"));
...
class GoogleCloudLogger extends _BaseLogger.default {
  debug(...args) {
...
exports.default = GoogleCloudLogger;
function log(msg) {
  const console = _env.isTTY ? global.console : _asyncConsole.default;
  console.log(msg);
}
